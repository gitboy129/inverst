...
#https://etf.dws.com/en-us/etf-products/?Asset%20Class%20Calculated=Equities&Region%20Calculated=Asia+%26+Pacific
#%20  space %26 &

res = urllib.request.urlopen("https://etf.dws.com/en-us/etf-products")
zfc1=res.read().decode('utf-8')
print(zfc1)
